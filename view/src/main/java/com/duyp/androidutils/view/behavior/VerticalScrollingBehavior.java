 ...
 * Behavior for Vertical scrolling in coordinator layout
 */
...
public abstract class VerticalScrollingBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
   ...
   */
    ...
    /**
     * @param coordinatorLayout layout
     * @param child child of coordinator layout
    ...
    @Override
    public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout,@NonNull  V child,@NonNull  View directTargetChild,
                                       @NonNull View target, int nestedScrollAxes) {
    ...
    protected abstract boolean onNestedDirectionFling(CoordinatorLayout coordinatorLayout, V child, View target,
