 ...
 * <a href="https://medium.com/@nullthemall/bottom-navigation-behavior-388b9b206667"></a>
 */
public final class BottomNavigationTranslateBehavior<V extends View> extends VerticalScrollingBehavior<V> {
    ...
    public BottomNavigationTranslateBehavior() {
        super();
    }

    public BottomNavigationTranslateBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public static <V extends View> BottomNavigationTranslateBehavior<V> from(@NonNull V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof BottomNavigationTranslateBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomNavigationTranslateBehavior");
        }
        return (BottomNavigationTranslateBehavior<V>) behavior;
    }
    ...
    private ViewGroup findTabLayout(@NonNull View child) {
        if (mTabLayoutId == 0 || !(child instanceof ViewGroup)) return null;
